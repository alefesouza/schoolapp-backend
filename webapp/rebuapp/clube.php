...
<body unresolved>
    ...
    <span flex id="titulo">Clube</span>
    </core-toolbar>
    <div class="container">
<? include("partes/other.php"); ?>
<?
if(isset($clube)) {
$grupoid = getGrupoID($clube); 
if($grupoid == "") {
} else {
...
?>
<paper-shadow z="0" class="littlecard<? if(isset($grupo) || !isset($clube)) { echo " clickable\""; } else { ?>" style="cursor: default;"<? } echo "".$grupo; ?>><? echo getClube($clube); ?> <? if(isset($grupo) || !isset($clube)) { echo "<paper-ripple fit class=\"recenteringTouch\"></paper-ripple>"; } ?></paper-shadow>
	<?
$result = mysqli_query($dbi, "SELECT * FROM eventos WHERE sala='$clube' ORDER BY date");
$count = 0;
...
if(mysqli_num_rows($result) == 0) {
	if(isset($clube)) { ?>
<paper-shadow z="0" class="littlecard" style="cursor: default;">Não há recados do seu clube</paper-shadow>
<?  } } ?>

...
Você não tem permissão para fazer isso se não for representante dessa sala<br><br>
<a onclick="window.history.back();" style="color: #0000ff; cursor: pointer;">Voltar</a>
</section>
</body>
</html>';
}

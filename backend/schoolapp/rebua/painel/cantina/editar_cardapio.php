 ...
 */
// Última modificação em: 31/03/2015 16:08
...
$values = mysqli_query($dbi, "SELECT * FROM eventos WHERE id='238'");
...
mysqli_query($dbi, "UPDATE eventos SET tipo='$tipo',descricao='$descricao',editadopor='$login' WHERE id='238'");

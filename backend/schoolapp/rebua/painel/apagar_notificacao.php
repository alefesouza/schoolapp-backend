 ...
 */
// Última modificação em: 07/03/2015 01:09
...
if ($info['sala'] == $infovalues['para'] || $info['tipo'] == "admin") {
	mysqli_query($dbi, "DELETE FROM notificacoes WHERE id='$id'");
...
<a href="agenda.php">Voltar</a></section>
</body>
</html>
<? }
mysqli_close($dbi);

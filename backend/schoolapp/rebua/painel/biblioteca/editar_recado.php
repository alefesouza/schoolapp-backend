 ...
 */
// Última modificação em: 26/03/2015 18:34
...
mysqli_query($dbi, "UPDATE eventos SET date='$date',tipo='$tipo',titulo='$titulo',descricao='$descricao',editadopor='$login' WHERE id='$id'");
...
<title>Editar recado - Painel RebuApp</title>

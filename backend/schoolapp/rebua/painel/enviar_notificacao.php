 ...
 */
// Última modificação em: 01/04/2015 21:39
...
switch($info['tipo']) {
	case "representante":
	$sumario = "Notificação do representante do ".getSala($info['sala']);
	break;
	case "clubelider":
	$sumario = "Notificação do clube de ".getClube($info['sala']);
	break;
	case "eletivaprofessor":
	$sumario = "Notificação da eletiva de ".getEletiva($info['sala']);
	break;
}

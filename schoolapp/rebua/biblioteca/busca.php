 ...
 */
// Última modificação em: 16/10/2014 02:17
...
$result = mysqli_query($dbi, "SELECT * FROM livros WHERE obra like('$busca%') OR autor like('$busca%') OR editora like('$busca%') order by obra");
...
while ($row = mysqli_fetch_array($result)) {
		...
		echo "<a href=\"http://google.com.br/search?q=".$row['obra']." ".$row['autor']."&aloogleapp=open\" target=\"_blank\">Pesquisar no Google</a>";

		if ($info['tipo'] == "bibliotecario" || $info['tipo'] == "admin") {

			echo "<br><br><a href=\"editar_livro.php?id=".$row['id']."&aloogleapp=needinternet\">Editar</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"apagar_livro.php?id=".$row['id']."&aloogleapp=needinternet\">Apagar</a>\n";

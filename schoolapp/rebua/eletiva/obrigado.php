 ...
 */
// Última modificação em: 15/10/2014 23:02
...
VALUES ('$sala', '$data', '$tema', '$descricao', '$login')";
	...
	echo "Recado adicionado!!<br><br>";

	echo "<a href=\"recados.php?eletivaroom=" . $info['sala'] . "\">Ver resultado</a>&nbsp;&nbsp;&nbsp;<a href=\"adicionar_evento.php\">Adicionar outro</a>";

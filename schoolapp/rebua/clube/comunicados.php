 ...
 */
// Última modificação em: 15/10/2014 22:06
?><html>
...
while ($row = mysqli_fetch_array($result)) {
	...
	if ($row['sala'] == $sala) {
		...
		if ($info['tipo'] == "gestao" || $info['tipo'] == "admin") {
			...
			echo "<a href=\"http://aloogle.is-best.net/schoolapp/rebua/clube/editar_comunicado.php?eventoid=".$row['id']."&aloogleapp=needinternet\">Editar</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"http://aloogle.is-best.net/schoolapp/rebua/clube/apagar_comunicado.php?eventoid=".$row['id']."&aloogleapp=needinternet\">Apagar</a>\n";
